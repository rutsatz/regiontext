 ...
 * @author rutsa
 */
public class CanvasComponent extends Application {
    ...
    private static Laco laco = new Laco();
    ...
    public void start(Stage primaryStage) {
        ...
        canvas.setOnMouseReleased(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent me) {
                ...
                PathTransition pt = new PathTransition(Duration.seconds(2), path, laco);
        ...
        vb.setLayoutY(20);
        vb.setLayoutX(10);
        vb.getChildren().addAll(toolBox, stackpane, canvas, laco);
